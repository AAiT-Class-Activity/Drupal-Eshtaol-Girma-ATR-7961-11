...
class __TwigTemplate_a18460cde9cfa735fca3e3e04517885b7d16c60703192016f33f4a8c1b366dae extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"slider-text\">
      <ul class=\"js-rotating\">
        ...
        if ((($context["slider_code"] ?? null) != "")) {
            // line 7
            echo "          ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(strip_tags($this->sandbox->ensureToStringAllowed(($context["slider_code"] ?? null), 7, $this->source), "<ol>,<ul>,<li>,<p>,<a>,<img>,<video>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6>,<em>,<strong>,<br>,<i>,<button>,<mark>,<hr>"));
            echo "
        ";
        } else {
            // line 9
...
";
    ...
    {
        return new Source("", "@edux/template-parts/slider.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/drupal-9.3.0/themes/edux/templates/template-parts/slider.html.twig");
    }
