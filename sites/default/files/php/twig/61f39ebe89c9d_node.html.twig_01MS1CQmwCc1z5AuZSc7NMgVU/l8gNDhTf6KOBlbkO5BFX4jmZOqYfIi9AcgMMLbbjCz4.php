...
/* themes/edux/templates/content/node.html.twig */
class __TwigTemplate_a3abba8d84c5666173d49dc9ab2b7a2a4502b578d4b8c9b0e594c9f07542813c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
      ...
      ";
            ...
            // line 94
            echo "      ";
            echo t("<span><i class=\"ficon-user submitted-icons\"></i> @author_name</span><span><i class=\"ficon-calendar submitted-icons\"></i> @createdDate</span>", array("@author_name" => ($context["author_name"] ?? null), "@createdDate" => ($context["createdDate"] ?? null), ));
            // line 95
            echo "      ";
            if (($context["node_tags"] ?? null)) {
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tags", [], "any", false, false, true, 96)) {
                    // line 97
                    echo "        <span><i class=\"ficon-tag submitted-icons\"></i>
        ";
                    // line 98
...
";
    ...
    {
        return "themes/edux/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/edux/templates/content/node.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/drupal-9.3.0/themes/edux/templates/content/node.html.twig");
    }
